...
<body>
	...
	<form action="<?php echo site_url('core/c_event/edit/'.@$object->event_id); ?>" method="POST" id="event_add">
		<table class="formtable">
			...
			<tr><td>Event Name</td><td><input type="text" name="eventn_name" name="event_name" value="<?php echo @$object->event_name; ?>" class="textbox"></td></tr>
			<tr><td>Event Description</td><td><textArea rows="5" cols="15" name="event_description" value="<?php echo @$object->event_description; ?>" ></textarea></td></tr>
